...
This uses grunt, assemble and handlebars to compile email ready HTML, using Zurb's Ink framework.
...
3. **Install Grunt and premailer**
4. **Choose a location for the script**
...
* **dist** contains your email output.
...
Inside src/emails, create a new file and call it *something***.hbs** or whatever you want your email to be called. The .hbs extension is very important. The system outputs HTML, but all the templates are written in handlebars
